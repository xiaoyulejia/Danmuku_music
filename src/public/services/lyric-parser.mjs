...
export function parseLrc(text) {
    ...
    source.split(/\r?\n/).forEach((line, lineIndex) => {
        ...
        const timestamps = [];
        line.replace(/\[(\d+:\d{1,2}(?:\.\d{1,3})?)\]/g, (_, timestamp) => {
...
export function mergeTranslation(original, translation, toleranceMs = 250) {
...
export function findLineIndex(lines, timeMs) {
